...
class listingRegexes {
	constructor() {
	    ...
	    this.noSavedToTravellersWishList = null
	    ...
	    this.monthlyDiscount = /(?:"monthly_discount":)([\w \d]+)/
	    ...
	    this.lastUpdated = /(?:,"last_updated":")([\w ]+)/
	    this.minNights = /(?:"min_nights":)([+-]?(?:\d*\.)?\d+)/
